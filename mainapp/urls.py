...
urlpatterns = [
    ...
    path('profile-edit/<int:pk>',
         PersonalProfileEditView.as_view(), name='profile-edit'),
    path('profile-info-edit/<int:pk>',
         ProfileInfoEditView.as_view(), name='profile-info-edit'),
    ...
    path('my-qualification/', ProfileQualificationView.as_view(),
         name='my-qualification'),
    path('my-verification/', ProfileVerificationView.as_view(),
         name='my-verification'),
    path('my-availability/', ProfileAvailabilityView.as_view(),
    ...
    path('add-qualification/', QualificationAddView.as_view(),
    ...
    path('add-verification/', VerificationAddView.as_view(),
         name='add-verification'),
    path('add-availability/', AvailabilityAddView.as_view(),
         name='add-availability'),

    # update view

    path(f'update/subject-{random.randint(10000,99999)}<int:pk>{random.randint(10000,99999)}/',
         SubjectUpdateView.as_view(), name='update_subject'),
    path(f'update/qualification-{random.randint(10000,99999)}<int:pk>{random.randint(10000,99999)}/',
         QualificationUpdateView.as_view(), name='update_qualification'),
    path(f'update/experience-{random.randint(10000,99999)}<int:pk>{random.randint(10000,99999)}/',
         ExperienceUpdateView.as_view(), name='update_experience'),
    path(f'update/verification-{random.randint(10000,99999)}<int:pk>{random.randint(10000,99999)}/',
         VerificationUpdateView.as_view(), name='update_verification'),
    path(f'update/availability-{random.randint(10000,99999)}<int:pk>{random.randint(10000,99999)}/',
         AvailabilityUpdateView.as_view(), name='update_availability'),

    # delete views

    path('delete/subject-<int:pk>',
         SubjectDeleteView.as_view(), name='delete_subject'),
    path('delete/profile-<int:pk>',
         ProfileDeleteView.as_view(), name='delete_profile'),
    path('delete/experience-<int:pk>',
         ExperienceDeleteView.as_view(), name='delete_experience'),
    path('delete/qualification-<int:pk>',
         QualificationDeleteView.as_view(), name='delete_qualification'),
    path('delete/verification-<int:pk>',
         VerificationDeleteView.as_view(), name='delete_verification'),
    path('delete/availability-<int:pk>',
         AvailabilityDeleteView.as_view(), name='delete_availability'),
    ...
    path('sub/<category_slug>/<subcat_slug>/',
         SubcategoryView.as_view(), name='subcategory'),
    path('subj/<category_slug>/<subcat_slug>/<subject_slug>/',
    ...
    path('request/<int:pk>', NotificationDetail.as_view(),
