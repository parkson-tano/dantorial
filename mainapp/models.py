...
class ProfilePersonal(models.Model):
    ...
    title = models.CharField(
        max_length=10, choices=TITLE, null=True, blank=True)
    ...
    level_of_education = models.CharField(
        max_length=50, choices=EL, null=True, blank=True)
    date_of_birth = models.DateField(default=timezone.now)
    ...
    profile_pic = models.ImageField(
        upload_to='profile_img', default='default.png')
...
class ProfileInfo(models.Model):
    ...
    category = models.ForeignKey(
        Category, on_delete=models.CASCADE, null=True, blank=True, related_name='main_category')
    ...
    charge = models.CharField(
        max_length=30, choices=CHARGE, null=True, blank=True)
...
class ProfileViewed(models.Model):
    ...
    viewed_by = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='user_view', null=True, blank=True)
    date_created = models.DateTimeField(auto_now_add=True)
...
class BillingPayment(models.Model):
    user = models.OneToOneField(
        User, on_delete=models.CASCADE, null=True, blank=True)
    billing = models.BigIntegerField(null=True, blank=True)
    payment = models.BigIntegerField(null=True, blank=True)
    date_created = models.DateTimeField(auto_now_add=True)

    def __str__(self):
        return str(self.user.profilepersonal) + ' payment'
